...
export default function AdminManageContracts() {
  ...
  const generateDocument = (contract) => {
    loadFile(
      "https://firebasestorage.googleapis.com/v0/b/rmy-project-fc361.appspot.com/o/pdfs%2Ftat_toan_hop_dong_thue_xe.docx?alt=media&token=f2e3ec7c-bd2d-457a-95ec-90aaed59e5a3",
