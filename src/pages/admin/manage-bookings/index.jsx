...
export default function AdminManageBookings() {
  ...
  const generateDocument = (booking) => {
    loadFile(
      "https://firebasestorage.googleapis.com/v0/b/my-project-fc361.appspot.com/o/pdfs%2Fhop_dong_thue_xe.docx?alt=media&token=53c0180b-1e6e-42b4-a8ad-88e9d181eae3",
